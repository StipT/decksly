...
import '../features/card_gallery/domain/repository/cards_repository.dart' as _i7;
import '../features/card_gallery/domain/usecase/fetch_cards_usecase.dart' as _i9;
import '../features/card_gallery/ui/bloc/card_gallery_bloc.dart' as _i12;
import '../features/deck_builder/domain/usecase/fetch_deck_code_usecase.dart' as _i10;
import '../features/deck_builder/ui/bloc/deck_builder_bloc.dart' as _i13;
import '../features/deck_selection/domain/repository/deck_repository.dart' as _i8;
import '../features/deck_selection/domain/usecase/fetch_deck_usecase.dart' as _i11;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i6.NetworkInfo>(() => _i6.NetworkInfoImpl(get<_i4.Connectivity>()));
  ...
  gh.lazySingleton<_i9.FetchCardsUsecase>(() => _i9.FetchCardsUsecase(get<_i7.CardsRepository>()));
  gh.lazySingleton<_i10.FetchDeckCodeUsecase>(() => _i10.FetchDeckCodeUsecase(get<_i8.DeckRepository>()));
  gh.lazySingleton<_i11.FetchDeckUsecase>(() => _i11.FetchDeckUsecase(get<_i8.DeckRepository>()));
  ...
  gh.factory<_i14.DeckSelectionBloc>(() => _i14.DeckSelectionBloc(get<_i11.FetchDeckUsecase>()));
  return get;
}
