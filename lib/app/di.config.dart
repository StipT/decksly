...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i9.FetchDeckCodeUsecase>(
      () => _i9.FetchDeckCodeUsecase(get<_i7.DeckRepository>()));
  gh.lazySingleton<_i10.FetchDeckUsecase>(
      () => _i10.FetchDeckUsecase(get<_i7.DeckRepository>()));
  gh.factory<_i11.CardGalleryBloc>(() => _i11.CardGalleryBloc(
        get<_i5.NetworkInfo>(),
        get<_i8.FetchCardsUsecase>(),
      ));
  gh.factory<_i12.DeckBuilderBloc>(() => _i12.DeckBuilderBloc(
        get<_i5.NetworkInfo>(),
        get<_i9.FetchDeckCodeUsecase>(),
      ));
