...
part of 'card_filter_params.dart';
...
class _$_CardFilterParams implements _CardFilterParams {
  ...
  @override
  String toString() {
    return 'CardFilterParams(pageSize: $pageSize, page: $page, locale: $locale, set: $set, heroClass: $heroClass, manaCost: $manaCost, attack: $attack, health: $health, collectible: $collectible, rarity: $rarity, type: $type, minionType: $minionType, keyword: $keyword, textFilter: $textFilter, gameMode: $gameMode, spellSchool: $spellSchool, sort: $sort)';
  }
  ...
  _$$_CardFilterParamsCopyWith<_$_CardFilterParams> get copyWith =>
      __$$_CardFilterParamsCopyWithImpl<_$_CardFilterParams>(this, _$identity);
}
