    ...
    return BlocBuilder<DeckBuilderBloc, DeckBuilderState>(
      builder: (BuildContext context, state) {
        return Container(
          ...
          child: Row(
            children: [
              Expanded(flex: 2, child: Container(margin: EdgeInsets.only(left: 6.w, top: 2.h, bottom: 3.h), child: Image.asset(assetPath(SUBFOLDER_MISC, "copy_deck_button"),)),),
              Image.asset(assetPath(SUBFOLDER_MISC, "wood_divider")),
              Container(margin: EdgeInsets.only(right: 5.w, top: 2.h, bottom: 3.h), child: Image.asset(assetPath(SUBFOLDER_MISC, "new_deck_button"),)),
            ],
          ),
        );
      },
